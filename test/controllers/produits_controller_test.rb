...
class ProduitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produit" do
    assert_difference('Produit.count') do
      post produits_url, params: { produit: { name: @produit.name, prix: @produit.prix, quantite: @produit.quantite } }
    end
  ...
  test "should update produit" do
    patch produit_url(@produit), params: { produit: { name: @produit.name, prix: @produit.prix, quantite: @produit.quantite } }
